...
class ProfileContainerView: UIView {
    ...
    private func createSubviews() {
        [avatarImageView, setStatusButton, statusLabel, fullNameLabel, statusTextField, profileButton].forEach { element in
            addSubview(element)
        ...
        NSLayoutConstraint.activate([
            ...
            profileButton.bottomAnchor.constraint(equalTo: safeAreaLayoutGuide.bottomAnchor),
